            ...
            <div className="flex flex-col md:flex-row gap-12 md:gap-8 mb-16 items-end justify-between">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-muted-foreground text-lg">
                  Không chỉ là viết code, tôi kể chuyện qua các sản phẩm số với
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="group bg-card rounded-2xl p-6 lg:p-8 border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 relative overflow-hidden hover:-translate-y-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Bắt đầu từ sự hiếu kỳ về cách web vận hành. Những dòng HTML
                  đầu tiên trên Notepad đã thắp lên đam mê kiến tạo những sản
                  phẩm hữu hình từ code trừu tượng.
                </p>
              </div>
              ...
              <div className="group bg-card rounded-2xl p-6 lg:p-8 border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 relative overflow-hidden hover:-translate-y-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Tôi tin rằng công nghệ xuất sắc nhất là khi nó hoạt động mượt
                  mà đến mức người dùng quên mất sự hiện diện của nó, chỉ còn
                  lại trải nghiệm thuần túy.
                </p>
              </div>
              ...
              <div className="group bg-card rounded-2xl p-6 lg:p-8 border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 relative overflow-hidden hover:-translate-y-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  &quot;Code không chỉ để máy chạy&quot;. Sự đơn giản là đỉnh
                  cao của sự tinh tế. Tôi viết code sạch, dễ bảo trì để đảm bảo
                  tính bền vững cho mọi dự án.
                </p>
              </div>
            </div>
          </div>
